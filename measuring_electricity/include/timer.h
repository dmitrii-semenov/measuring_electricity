...
/** @brief Set overflow 128usms, prescaler 001 --> 1 */
...
/** @brief Set overflow 2ms, prescaler // 100 --> 256 */
#define TIM2_OVF_2MS  TCCR2B &= ~(1<<CS21); TCCR2B |= (1<<CS22) | (1<<CS20);
/** @brief Set overflow 4ms, prescaler // 101 --> 512 */
#define TIM2_OVF_4MS  TCCR2B &= ~(1<<CS20); TCCR2B |= (1<<CS22) | (1<<CS21);
/** @brief Set overflow 26ms, prescaler // 110 --> 1024 */
